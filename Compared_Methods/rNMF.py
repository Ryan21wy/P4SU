...
The code was copied from https://github.com/neel-dey/robust-nmf/blob/master/backends/numpy_functions.py.
...
def robust_nmf(data, rank, beta, reg_val, init='random', sum_to_one=True, tol=1e-7, max_iter=1000,
               print_every=-1, user_prov=None, update_end=False):
    '''
    ...
    Input:
        ...
        3. beta: parameter of the beta-divergence used.
            ...
            assumption)
        4. reg_val: Weight of L-2,1 regularization.
        5. init: Initialization method used for robust NMF.
            ...
            'outlier'.
            init == 'basis': the user can provide their own initialization of basis.
        ...
        9. print_every: Number of iterations at which to show optimization progress.
...
def initialize_rnmf(data, rank, alg, beta=2, sum_to_one=0, user_prov=None):
    ...
    #     return basis+eps, coeff+eps, outlier+eps
        ...
        print('Initializing rNMF with user provided basis.')
        ...
        return basis, coeff+eps, outlier+eps
    else:
